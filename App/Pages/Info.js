...
const Info = ({ route }) => {
  ...
  <View style={styles.ratingBox}>
    <View style={styles.ratingBlock}>
      ...
      <Text style={styles.ratingStars}>{renderStars(5)}</Text>
    </View>
    <View style={styles.divider} />
    <Text style={styles.deliversLeft}>{`${deliveries} deliveries left`}</Text>
    <View style={styles.divider} />
    <View style={styles.contactBlock}>
      <IonIcons name="person-sharp" size={22} style={styles.contactIcon} />
      <Text style={styles.contactText}>contact owner</Text>
        ...
        <Text style={styles.cartPrompt}>Ready to fill your cart?</Text>
        <Button
          theme={theme} 
          mode="contained"
          contentStyle={styles.yesButtonContent}
          style={styles.yesButton}
          labelStyle={styles.yesButtonText}
